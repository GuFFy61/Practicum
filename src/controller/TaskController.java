...
// Класс содержит CRUD методы для задач типа "задача"
public class TaskController {
    ...
    public Task update(Task task) {
        ...
        if (originalTask == null) {
            System.out.println("Задачи с таким типом ID не существует.");
            return null;
        }
    ...
    public Task create(Task task) {
        ...
        if (!tasks.containsKey(newTask.getId())) {
            ...
            System.out.println("Задача с таким типом ID уже существует");
            return null;
        }
        return newTask;
    }
